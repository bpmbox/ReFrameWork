<Activity mc:Ignorable="sap sap2010" x:Class="controller転記シートに登録" this:controller転記シートに登録.転記シートID="12" this:controller転記シートに登録.転記シートIID="11" this:controller転記シートに登録.テンプレートファイル="Input\Book1.xlsx" this:controller転記シートに登録.dic="[New Dictionary(Of String,String)]" this:controller転記シートに登録.リスト="[new List(Of String)]" this:controller転記シートに登録.作業時間="[DateTime.Now.ToString(&quot;yyyy/MM/dd HH:mm:ss&quot;)]" this:controller転記シートに登録.in_判定条件="10" xmlns="http://schemas.microsoft.com/netfx/2009/xaml/activities" xmlns:av="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" xmlns:mva="clr-namespace:Microsoft.VisualBasic.Activities;assembly=System.Activities" xmlns:s="clr-namespace:System;assembly=mscorlib" xmlns:sap="http://schemas.microsoft.com/netfx/2009/xaml/activities/presentation" xmlns:sap2010="http://schemas.microsoft.com/netfx/2010/xaml/activities/presentation" xmlns:scg="clr-namespace:System.Collections.Generic;assembly=mscorlib" xmlns:sd="clr-namespace:System.Data;assembly=System.Data" xmlns:sd1="clr-namespace:System.Diagnostics;assembly=System" xmlns:ss="clr-namespace:System.Security;assembly=mscorlib" xmlns:this="clr-namespace:" xmlns:uga="clr-namespace:UiPath.GSuite.Activities;assembly=UiPath.GSuite.Activities" xmlns:ui="http://schemas.uipath.com/workflow/activities" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml">
  <x:Members>
          ...
          <Flowchart sap:VirtualizedContainerService.HintSize="1257.6,1523.2" sap2010:WorkflowViewState.IdRef="Flowchart_1">
            ...
            <FlowStep x:Name="__ReferenceID3">
              ...
              <Sequence sap2010:Annotation.AnnotationText="下記を初期化する&#xA;&#xA;登録データ&#xD;&#xA;複数の入力シート&#xA;出力データ&#xA;マップデータ&#xA;文字変換データ&#xD;&#xA;登録時間" DisplayName="初期化処理 Sequence" sap:VirtualizedContainerService.HintSize="200,200.8" sap2010:WorkflowViewState.IdRef="Sequence_43">
                ...
                <ui:ExcelApplicationScope Password="{x:Null}" sap2010:Annotation.AnnotationText="物理名　論理名が異なる場合の変換用のデータ取得&#xA;&#xA;取得したデータに変換文字列がある場合にの変換用テーブル&#xA;IN　&quot;C:\Users\USER\Documents\Book1.xlsx&quot;&#xA;framwork pDictionary から　インプットシートを取得" DisplayName="文字列変換用データ取得 Excel Application Scope" sap:VirtualizedContainerService.HintSize="558.4,200.8" sap2010:WorkflowViewState.IdRef="ExcelApplicationScope_7" Visible="False" WorkbookPath="[テンプレートファイル]">
                  <ui:ExcelApplicationScope.Body>
                    <ActivityAction x:TypeArguments="ui:WorkbookApplication">
                      <ActivityAction.Argument>
                        <DelegateInArgument x:TypeArguments="ui:WorkbookApplication" Name="ExcelWorkbookScope" />
                        ...
                        <FlowSwitch x:TypeArguments="x:Int32" x:Name="__ReferenceID2" DisplayName="Flow Switch" Expression="[判定条件]" sap:VirtualizedContainerService.HintSize="76,87.2" sap2010:WorkflowViewState.IdRef="FlowSwitch`1_3">
                          <FlowSwitch.Default>
                            <FlowStep x:Name="__ReferenceID4">
                              ...
                              <Sequence sap2010:Annotation.AnnotationText="明細から明細へ登録&#xA;入力タイプ 10&#xA;ＩＤがある場合は更新&#xA;ＩＤがない場合は登録&#xA;" DisplayName="T001_データの転記 マップ１ Sequence" sap:VirtualizedContainerService.HintSize="1570.4,5236" sap2010:WorkflowViewState.IdRef="Sequence_90">
                                <sap:WorkflowViewStateService.ViewState>
                                  <scg:Dictionary x:TypeArguments="x:String, x:Object">
                                    <x:Boolean x:Key="IsExpanded">True</x:Boolean>
                                    <x:Boolean x:Key="IsAnnotationDocked">True</x:Boolean>
                              ...
                              <TryCatch DisplayName="Try Catch" sap:VirtualizedContainerService.HintSize="827.2,3137.6" sap2010:WorkflowViewState.IdRef="TryCatch_3">
                                ...
                                <TryCatch.Try>
                                  <Sequence DisplayName="シートに転記をして追加 Sequence" sap:VirtualizedContainerService.HintSize="790.4,2910.4" sap2010:WorkflowViewState.IdRef="Sequence_134">
                                    ...
                                    <ui:OutputDataTable DataTable="[コピー先データテーブル]" DisplayName="Output Data Table" sap:VirtualizedContainerService.HintSize="599.2,22.4" sap2010:WorkflowViewState.IdRef="OutputDataTable_4" Text="[ログ内容]" />
                                    <ui:ExcelApplicationScope Password="{x:Null}" DisplayName="Excelに転記レコードをコピー出力をする Excel Application Scope" sap:VirtualizedContainerService.HintSize="599.2,517.6" sap2010:WorkflowViewState.IdRef="ExcelApplicationScope_16" WorkbookPath="[出力ファイル]">
                                      <ui:ExcelApplicationScope.Body>
                                        <ActivityAction x:TypeArguments="ui:WorkbookApplication">
                                          <ActivityAction.Argument>
                                            <DelegateInArgument x:TypeArguments="ui:WorkbookApplication" Name="ExcelWorkbookScope" />
                                ...
                                <TryCatch.Catches>
                                  <Catch x:TypeArguments="s:Exception" sap:VirtualizedContainerService.HintSize="644,21.6" sap2010:WorkflowViewState.IdRef="Catch`1_3">
                                    <sap:WorkflowViewStateService.ViewState>
                                      <scg:Dictionary x:TypeArguments="x:String, x:Object">
                                        <x:Boolean x:Key="IsExpanded">False</x:Boolean>
                                        <x:Boolean x:Key="IsPinned">False</x:Boolean>
